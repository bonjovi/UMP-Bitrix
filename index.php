...
<div class="container">
 ...
 <section class="directions">
	...
	<div class="row directions__row">
		...
		<div class="col-lg-4 directions__item" style="visibility:hidden;">
	...
	<div class="container">
		<div class="row">
			<div class="col-md-6 lotointro__left">
				<img class="lotointro__pic" src="<?=SITE_TEMPLATE_PATH?>/img/loto-pic.png" alt="">
			</div>
...
<section class="staydealer">
	<div class="container">
		<div class="row">
			...
			<div class="col-md-6">
				<img src="<?=SITE_TEMPLATE_PATH?>/img/staydealer.png" width="120" class="staydealer__icon" alt="">
			</div>
		</div>
	</div>
</section><!-- /.staydealer -->
