...
<script>
$(function() {
	$('.product-item').map(function() {
		$(this).find('.product-item-image-original').attr('style', $(this).find('.product-item-image-alternative').attr('style'));
	});
});
</script>


<div class="container catalog-section bx-<?=$arParams['TEMPLATE_THEME']?>" data-entity="<?=$containerName?>">
	<?
