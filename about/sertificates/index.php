...
?><div class="container simplepage">
	...
	<div class="text text_grey text_medium">
		 Мы официально представляем в РФ продукцию торговых марок Brady, Klauke, Greenlee, Weicon, SIC Marking,&nbsp;General Cable, Leoni, TF Kabel. Наши сертификаты, подтверждающие данный статус:
	</div>
